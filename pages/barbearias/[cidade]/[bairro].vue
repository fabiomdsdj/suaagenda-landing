      ...
      <section class="pt-28 pb-6 px-6 md:px-16 bg-[#0a0a0a] border-b border-white/5">
        <div class="max-w-6xl mx-auto">
          <nav class="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
            ...
            <span class="text-gray-700">/</span>
            <span class="text-gray-400">{{ seo.neighborhoodName }}</span>
          </nav>
        </div>
      </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2 space-y-8">
            ...
            <div class="rounded-2xl border border-white/[.06] bg-[#181818] p-8">
              <h2
                class="font-black leading-none mb-6 text-white"
                style="font-family:'Bebas Neue',sans-serif;font-size:clamp(24px,2.5vw,36px)"
              >
              ...
              <ol class="list-none p-0 m-0 space-y-4">
                <li
                  ...
                  :key="i"
                  class="flex items-start gap-4 py-4 border-b border-white/[.05] last:border-0"
                >
                  <span
                    class="w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center text-sm font-bold text-green-400 bg-green-400/10 border border-green-400/30"
                  >{{ i + 1 }}</span>
                  <div>
            ...
            <div class="grid grid-cols-3 gap-4">
              <div
                ...
                :key="stat.label"
                class="rounded-xl border border-green-400/10 bg-[#181818] p-5 text-center"
              >
                <p
          ...
          <aside class="space-y-6">
            ...
            <div class="rounded-2xl border-2 border-green-400 bg-[#181818] p-7 relative overflow-hidden">
              ...
              <p class="text-[14px] text-gray-400 leading-relaxed mb-5">
                Cria sua conta, confirma os serviços e já tem site profissional nas primeiras posições do Google — sem mexer em nada técnico.
              </p>
              <a
                href="https://wa.me/5511941649284"
      ...
      <section class="w-full py-20 px-6 md:px-16 bg-[#0a0a0a]">
        <div class="max-w-6xl mx-auto">
          ...
          <h2
            ...
            style="font-family:'Bebas Neue',sans-serif;font-size:clamp(36px,4.5vw,56px)"
          >
            O QUE MUDA PRA UM BARBEIRO DE<br>
            <span class="text-green-400">{{ seo.neighborhoodName.toUpperCase() }}</span>
          </h2>
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div
              ...
              :key="i"
              class="group relative overflow-hidden rounded-2xl border border-green-400/10 bg-[#181818] p-7 transition-all duration-200 hover:-translate-y-1 hover:border-green-400/40"
            >
      ...
      <section class="relative w-full py-24 px-6 md:px-16 bg-[#111] text-center overflow-hidden">
        ...
        <div class="relative max-w-xl mx-auto">
          <span class="text-xs font-bold tracking-widest uppercase text-green-400 block mb-4">
            Barbearias em {{ seo.neighborhoodName }}
          </span>
          <h2
          ...
          <p class="mb-8 text-[17px] leading-relaxed text-gray-400">
            Barbeiros em {{ seo.neighborhoodName }} que usam a SuaAgenda aparecem quando alguém busca
            "barbearia em {{ seo.neighborhoodName }}" no Google — sem pagar anúncio.
          </p>
          <a
            href="https://wa.me/5511941649284"
