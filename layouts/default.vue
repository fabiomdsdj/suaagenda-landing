      ...
      <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="fade-on-scroll opacity-0 translate-y-10 transition-all duration-700" data-delay="800">
          ...
          <div class="flex gap-4">
            ...
            <!-- Facebook -->
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" class="hover:text-yellow-400 transition flex items-center gap-2">
            ...
            <!-- Instagram -->
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" class="hover:text-yellow-400 transition flex items-center gap-2">
            ...
            <!-- YouTube vermelho -->
            <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" class="transition flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-12 h-12 fill-current text-red-600 transition">
                <path d="M549.655 124.083c-6.281-23.722-24.816-42.284-48.556-48.557C456.177 64 288 64 288 64s-168.177 0-213.099 11.526c-23.74 6.273-42.275 24.835-48.556 48.557C16 169.008 16 256 16 256s0 86.992 10.345 131.917c6.281 23.722 24.816 42.284 48.556 48.557C119.823 448 288 448 288 448s168.177 0 213.099-11.526c23.74-6.273 42.275-24.835 48.556-48.557C560 342.992 560 256 560 256s0-86.992-10.345-131.917zM232 336V176l142 80-142 80z"/>
              </svg>
            </a>
